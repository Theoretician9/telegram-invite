...
7. Для новых страниц сразу прописывать маршруты в app.py, чтобы избежать ошибок 404 Not Found
...
## Май 2025: Исправления скачивания файлов
- Исправлена ошибка скачивания результата парсинга: убран аргумент download_name из send_file (Quart не поддерживает), добавлен заголовок Content-Disposition вручную.
- Теперь скачивание результата парсинга работает корректно во всех браузерах. 