...
## Май 2025: Исправления массового инвайта и стабильности Quart
- Endpoint /api/bulk_invite теперь только сохраняет файл и ставит задачу в Celery, не читая и не парся файл в самом endpoint.
- Это устраняет блокировку event loop Quart и проблему 502 Bad Gateway при массовом инвайте. 